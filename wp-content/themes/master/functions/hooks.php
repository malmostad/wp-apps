...
function set_mce_options( $init ) {
  ...
  $init['toolbar1'] = "undo,redo,|,formatselect,|,italic,|,bullist,numlist,outdent,indent,blockquote,|,pastetext,pasteword,removeformat,|,link,unlink,|,valideratext,|,dfw,|,wp_help";
  $init['toolbar2'] = "";
